			...
			<form id="volver" action="EditarPrestamo.html" method="post">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-6	">
						<label for="ddlLibro">Libro</label> <input type="text"
							class="form-control" name="txtCliente" value="${Libro.titulo}"
							disabled>
					</div>

					<div class="form-group col-md-6">
						<label for="txtFecha">Fecha de Alta</label> <input type="date"
							id="txtFecha" name="txtFecha" class="form-control datepicker"
							value="${FechaAlta}" disabled>
					</div>
				...
				<div class="form-row">
					...
					<div class="form-group col-md-6	">
						<label for="txtCantidad">Cantidad de Dias</label> <input
							type="number" class="form-control" name="txtCantidadDias" min="1"
							max="365" value="${CantidadDias}">
					</div>

					<div class="form-group col-md-6	">
						<label for="cliente">Cliente</label> <input type="text"
							class="form-control" name="txtCliente" value="${Cliente.nombres}"
							disabled>
					</div>

				</div>
				<button type="submit" class="btn btn-primary"
					onclick="confirmarAgregar()">Guardar</button>
				<input type="hidden" id="txtAgregar" name="txtAgregar"
					class="form-control" value="no"> <input type="hidden"
					id="IdPrestamo" name="IdPrestamo" class="form-control"
					value="${Prestamo.id}">
			</form>
		</div>
	</div>
