...
<body onLoad="mostrarMensaje()">
	...
	<div class="parteDer">
		...
		<form action="Redireccionar_PrestamosAlta.html" method="get">
			<input type="submit" value="Nuevo Prestamo" name="btnConfirmar"
					...
					<tr>
						...
						<td style="text-align: center">
							<form action="Redireccionar_EditarPrestamo.html" method="post">
								...
								<input type="hidden" id="txtEditar" name="txtEditar"
									class="form-control" value="${item[0].id}">
							</form>
						</td>
						<td style="text-align: center">
							<form action="EliminarPrestamo.html" method="post">
								...
								<input type="hidden" id="txtEliminar" name="txtEliminar"
									class="form-control" value="${item[0].id}"> <input
						...
						<td style="text-align: center">${item[0].cliente.nombres}
							${item[0].cliente.apellidos}</td>
					</tr>
