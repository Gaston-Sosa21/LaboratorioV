				...
				<div class="form-row">
					...
					<div class="form-group col-md-6	">
						<label for="ddlLibro">Libro</label> <select id="ddlLibro"
							name="ddlLibro" class="form-control" required>
					...
					<div class="form-group col-md-6">
						<label for="txtFecha">Fecha de Alta</label> <input type="text"
				...
				<div class="form-row">
					...
					<div class="form-group col-md-6	">
						<label for="txtCantidad">Cantidad de Dias</label> <input
							type="number" class="form-control" name="txtCantidad" value="1"
