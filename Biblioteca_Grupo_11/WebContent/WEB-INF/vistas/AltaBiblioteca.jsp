				...
				<div class="form-row">
					...
					<div class="form-group col-md-6	">
						<label for="txtEstado">Estado</label> <input type="text"
							id="txtEstado" name="txtEstado" class="form-control"
							value="En biblioteca" disabled>
					</div>
				</div>
				<!-- END DIV -->
				<div class="form-row">
					<div class="form-group col-md-6">
						<label for="fechaNacimiento">Fecha de Alta</label> <input
							type="text" id="txtFecha" name="txtFecha"
							class="form-control datepicker" value="${date}" disabled>
					</div>
				</div>
				<button type="submit" class="btn btn-primary"
					onclick="confirmarAgregar()">Agregar</button>
