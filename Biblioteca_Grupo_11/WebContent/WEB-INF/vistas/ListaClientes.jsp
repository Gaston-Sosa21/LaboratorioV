...
<link rel="stylesheet" href="/Biblioteca_Grupo_11/css/Clientes.css" type="text/css" media="screen" />
...
<div class="parteDer" >
	...
	<div class="titulo1">
	 ...
	 <form action = "Redireccionar_ClienteAlta.html" method="get">	
			<input type="submit" value="Nuevo Cliente" name="btnConfirmar"  class="btn btn-dark botonAlta"><br>
	</form> 
	      ...
	      <td style="text-align:center">
		      <form action = "Redireccionar_EdicionCliente.html" method="get">	
					...
					<!-- <input type="submit" value="Editar" name="btnEditar"  class="btn btn-primary" ><br> -->
						<input type="hidden" id="txtID" class="form-control"  name="IdCliente" value="${row.id}">
				
			  </form> 
	      </td>
	      <td style="text-align:center"> <form action="EliminarCliente.html" method="post"> 
	    	<button type="submit" class="btn btn-danger" onclick="confirmarEliminar2()">
				<i class="fa fa-close"></i>
			</button>
	      <input type="hidden" class="form-control" name="EliminarCliente" id="EliminarCliente" value="${row.id}"></input>  
