...
<link rel="stylesheet" href="/Biblioteca_Grupo_11/css/login.css"
	type="text/css" media="screen" />
	...
	<div class="content">
		...
		<div class="text-center">
			<form action="Redireccionar_PostLogin.html" method="post">
				<div class="loginDiv">
					<br>
					<br> <label>Nombre de usuario</label><br> <input
						type="text" name="txtUsuario" class="col-12 inputs"
						placeholder="Nombre"><br>
					<br> <label>Contraseña</label><br> <input type="password"
						name="txtClave" class="col-12 inputs" placeholder="Contraseña"><br>
					<br>
					<br> <input type="submit" value="INGRESAR" name="btnConfirmar"
						class="btn btn-primary col-6"><br> <span></span>
			</form>
		</div>
	</div>

	<footer class="footerIndex">
		<p>Ricardo Recofsky - Gastón Sosa - Francisco Madoery - Marcos
			Zone</p>
		<p>© LAB V 2022 | Carrera TUSI - UTN FRGP | Desarrollado por
			alumnos UTN FRGP.</p>
	</footer>
	</div>
</body>
