...
<body>
	...
	<div class="dropdown">
		...
		<div class="dropdown-menu text-center">
			...
			<div class="titulo2">
				<img src="img/biblioteca.jpg" id="ImagenMenu" width="200"
					height="200">
			</div>
		...
		<div>
			...
			<ul>
				<form action="Redireccionar_ListaClientes.html" method="get">
					<input type="submit" value="CLIENTES" name="btnConfirmar"
	...
	<div class="parteDer">
		...
		<form action="GuardarCliente.html" method="post" id="formulario">
			...
			<input type="hidden" id="txtID" class="form-control" name="IdCliente"
				value="${DatosCliente.id}"> <br>
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="inputNombre">Nombre</label> <input type="nombre"
						class="form-control" id="inputNombre" name="txtNombre"
						value="${DatosCliente.nombres}" maxlength="25"
						onkeypress="return SoloLetras(event);">
				</div>
				<div class="form-group col-md-6">
					<label for="inputPassword4">Apellido</label> <input type="apellido"
						class="form-control" id="inputApellido" name="txtApellido"
						value="${DatosCliente.apellidos}" maxlength="25"
						onkeypress="return SoloLetras(event);">
				</div>
			</div>
			...
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="fechaNacimiento">Fecha de Nacimiento</label> <input
						type="date" name="txtFecha" id="txtFecha"
				...
				<div class="form-group col-md-6">
					<label for="inputDni">DNI</label> <input type="text"
						class="form-control" id="inputDni" name="txtDni" maxlength="8"
						onkeypress="return valideKey(event);" value="${DatosCliente.dni}">
				</div>
			</div>

			<div class="form-group">
				<label for="inputAddress">Direccion</label> <input type="text"
					class="form-control" id="inputDirecccion" placeholder=""
					name="txtDireccion" value="${DatosCliente.direccion}">
			</div>
			...
			<div class="form-row">
				...
				<div class="form-group col-md-6">
					<label for="txtNacionalidad">Nacionalidad</label> <select
						id="nacionalidad" name="txtNacionalidad" class="form-control">
				...
				<div class="form-group col-md-6">
					<label for="inputLocalidad">Localidad</label> <select
						id="inputLocalidad" class="form-control" name="txtLocalidad">
			...
			<div class="form-row">
				...
				<div class="form-group col-md-6">
					<label for="inputEmail">Email</label> <input type="text"
						class="form-control" id="inputEmail" placeholder="" name="txtMail"
						value="${DatosCliente.email}" required>
				</div>

				<div class="form-group col-md-6">
					<label for="inputTelefono">Telefono</label> <input type="text"
						class="form-control" id="inputTelefono" placeholder=""
						maxlength="10" name="txtTelefono"
			...
			<div>
				<button type="submit" class="btn btn-primary"
					onclick="confirmarGuardar()">Guardar</button>
				<input type="hidden" id="txtGuardar" name="txtGuardar"
